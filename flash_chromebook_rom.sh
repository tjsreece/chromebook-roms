...
readonly URL_PREFIX=https://raw.githubusercontent.com/tjsreece/chromebook-roms/refs/heads/main/flash_chromebook_rom.sh
...
update_legacy_slot () {
  ...
  acceptance
  "$FLASHROM_CMD" -w -i RW_LEGACY:"$LEGACY_FILE"-latest.cbfs || err "
